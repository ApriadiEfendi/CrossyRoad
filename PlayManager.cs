...
public class PlayManager : MonoBehaviour
{
    ...
    private void Start()
    {
        //create initial land pos -4 --- 4
        for (int zPos = backViewDistance; zPos < initialLandCount; zPos++)
        {
            ...
            if (terrain is Land land)
                land.SetTreePercentage(zPos < -1 ? 1 : 0);
        ...
        // 4 --- 15
        for (int zPos = initialLandCount; zPos < forwardViewDistance; zPos++)
        {
